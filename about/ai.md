...
1. If **publication** of AI generated language is a feature (arxiv, conference, issue tracker, online discussion), then [above](#ai-applied-to-usethesource-source-code-itself-no), with code replaces by natural language text.
